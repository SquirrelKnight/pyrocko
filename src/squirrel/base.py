...
from .operators.base import Operator, CodesPatternFilter
    ...
    **Method summary**
    ...
    def get_stationxml(
        ...
        nslcs = list(set(
            ...
            filter.filter(self.get_codes(kind='channel'))))
    ...
    def get_location_pool(self, tmin=None, tmax=None):
        return model.LocationPool(self, tmin=tmin, tmax=tmax)
    ...
    def update_operator_mappings(self):
        ...
        for operator in self._operators:
            operator.update_mappings(
                available, self, None, None, self._operator_registry)
